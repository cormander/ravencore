...
$trans['es_AR'] = array(
	...
	'Invalid password. Must only contain letters and numbers, must be atleast 5 characters, and not a dictionary word' => 'Contraseña inv&aacute;lida. Debe usar solamente letras y números, m&aacute;s de 5 caracteres y no usar una palabra del diccionario',
	...
	'The password is incorrect!' => '&iexcl;La contraseña es incorrecta!',
	'The new password must be greater than 4 characters and not a dictionary word' => 'La nueva contraseña debe tener m&aacute;s de 4 caracteres y no debe ser una palabra del diccionario',
	'Cannot select MySQL database' => 'No se pudo seleecionar la base de datos MySQL',
	'Cannot change database password' => 'No se pudo cambiar la contraseña de la base de datos',
	...
	'Your passwords are not the same!' => '&iexcl;Sus contraseñas no son las mismas!',
	'Please change the password for' => 'Por favor cambie la contraseña por',
	'Changing' => 'Cambiar',
	'password!' => '&iexcl;contraseña!',
	...
	'Search' => 'Buscar',
	'Please enter in a search value!' => '&iexcl;Por favor ingrese una búsqueda!',
	'Show All' => 'Mostrar Todo',
	'There are no databases setup' => 'No hay bases de datos configuradas',
	'Your search returned' => 'Su búsqueda devuelve',
	'results' => 'resultados',
	'Domain' => 'Dominio',
	'Database' => 'Base de datos',
	...
	'Go' => 'ir',
	'Please enter a search value!' => '&iexcl;ingrese por favor un valor de búsqueda!',
	...
	'Invalid domain name. May only contain letters, numbers, dashes and dots. Must not start or end with a dash or a dot, and a dash and a dot cannot be next to each other' => 'Nombre de Dominio inv&aacute;lido. Puede contener solamente letras, números, guiones y puntos. No debe empezar o terminar con un gui&oacute;n o un punto, y un gui&oacute;n o un punto no pueden estar al lado de otro',
	...
	'Your passwords do not match' => 'Las contraseñas no son las mismas',
	...
	'Invalid password. Must only contain letters and numbers.' => 'Contraseña inv&aacute;lida. Debe contener letras y números',
	...
	'Invalid mailname. it may only contain letters, number, dashes, dots, and underscores. Must both start and end with either a letter or number.' => 'Nombre de mail no v&aacute;lido. Puede contener solamente letras, números, puntos, y rayas. El comienzo y fin necesitan letra o número',
	...
	'You must enter a password for this user' => 'Debe ingresar una contraseña para este usuario',
	'Your password must be atleast 5 characters long, and not a dictionary word.' => 'Su contraseña debe tener al menos 5 caracteres, y no debe ser una palabra del diccionario.',
	...
	'You must make a rotation selection: filesize, date, or both' => 'Usted debe hacer una selecci&oacute;n de la rotaci&oacute;n:  tamaño de archivo, fecha, o ambos',
	'Keep' => 'Subsistir',
	...
	'No domains setup, so there are no Log files' => 'No hay dominios configurados, entonces no hay ningún archivo de registro de actividades',
	...
	'Change the admin password' => 'Cambia la contraseña de administrador',
	'Change Admin Password' => 'Cambiar la Contrasña de Administrador',
